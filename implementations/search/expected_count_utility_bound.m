...
%
% function bound = probability_bound(data, labels, train_ind, ...
...
function bound = expected_count_utility_bound(data, labels, train_ind, ...
  ...
  current_probability_bound = probability_bound(data, labels, ...
  ...
  if (lookahead == 1)
    ...
    bound = ...
        current_probability_bound * ...
        (1 + expected_count_utility_bound(data, labels, train_ind, ...
