...
% count_utility).
%
% function test_ind = active_search_bound_selector(data, labels, ...
...
function test_ind = active_search_bound_selector(data, labels, ...
  ...
  selection_functions{lookahead} = ...
      @(data, labels, train_ind) (one_step_optimal_ind);
  ...
  p_star_expected_utility = find_optimal_point(data, labels, ...
  ...
  one_fewer_step_optimal_utility = find_optimal_point(data, labels, ...
          train_ind, utility_function, probability_function, ...
  ...
  one_fewer_step_utility_bound = ...
      expected_count_utility_bound(data, labels, train_ind, ...
