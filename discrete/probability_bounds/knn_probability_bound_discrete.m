...
%
% function probability_bound = knn_probability_bound_discrete(responses, train_ind, ...
...
%
% outputs:
%   probability_bound: an upper bound for the probabilities of the test data
%
