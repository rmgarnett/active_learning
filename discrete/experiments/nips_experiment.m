...
[random_estimated_proportions random_proportion_variances random_chosen] ...
    = iterative_surveying_variance_target(data, responses, in_train, ...
        utility_function, proportion_estimation_function, variance_target, ...
        true);
...
[uncertainty_estimated_proportions uncertainty_proportion_variances ...
 uncertainty_chosen] = iterative_surveying_variance_target(data, ...
        responses, in_train, utility_function, ...
        proportion_estimation_function, variance_target, true);
...
disp(['uncertainty sampling: ' ...
      num2str(uncertainty_estimated_proportions(end)) ' +/- ' ...
      num2str(sqrt(uncertainty_proportion_variances(end))) ', actual: ' ...
      num2str(actual_proportion) ', test likelihood: ' ...
      num2str(uncertainty_likelihood)]);
...
[optimal_estimated_proportions optimal_proportion_variances ...
 optimal_chosen] = iterative_surveying_variance_target(data, responses, ...
        in_train, utility_function, proportion_estimation_function, ...
        variance_target, true);
...
%  battleship_chosen] = iterative_surveying_variance_target(data, responses, in_train, ...
%         utility_function, proportion_estimation_function, variance_target, ...
%         true);
